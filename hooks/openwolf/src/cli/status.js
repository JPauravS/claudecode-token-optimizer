...
/* LOCAL MOD (claude-stack): status dual-.wolf */
...
function _resolveWolfPath(file, wolfDir) {
...
export async function statusCommand() {
    ...
    for (const file of requiredFiles) {
        const exists = fs.existsSync(_resolveWolfPath(file, wolfDir)) /* LOCAL MOD (claude-stack): status dual-.wolf */;
        if (!exists) {
