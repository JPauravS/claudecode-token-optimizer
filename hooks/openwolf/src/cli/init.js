// // LOCAL MOD (claude-stack): dropped designqc/reframe
...
const ALWAYS_OVERWRITE = [
    "OPENWOLF.md",
    "config.json",
    // // LOCAL MOD (claude-stack): dropped designqc/reframe: removed "reframe-frameworks.md"
];
...
const CREATE_IF_MISSING = [
    ...
    "cron-manifest.json",
    "cron-state.json",
    // // LOCAL MOD (claude-stack): dropped designqc/reframe: removed "designqc-report.json"
    "suggestions.json",
];
